...
The algorithm used is xoroshiro32++, stepped twice to generate 2x16 bits of data. Since the state is only 32 bits, results and seeds map 1:1 to eachother. Ideal properties are only guaranteed if only the top or bottom 16 bits of the generated number are used.
